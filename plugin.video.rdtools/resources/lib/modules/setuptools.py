...
def FirstStart():
    ...
    try:
            LANG = 'en'
            source_thumbnail = xbmcvfs.translatePath(os.path.join('special://home/addons/plugin.video.rdtools','icon.png'))
            source_name = "Real-Debrid Tools TV SHOWS"
    ...
    try:
            ...
            source_thumbnail = xbmcvfs.translatePath(os.path.join('special://home/addons/plugin.video.rdtools','icon.png'))
            source_name = "Real-Debrid Tools MOVIES"
