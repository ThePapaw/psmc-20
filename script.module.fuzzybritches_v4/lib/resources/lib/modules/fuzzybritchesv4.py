...
def router(params):
    ...
    #CM 2021/17/7 @todo obsolete part
        ...
        c.log('[CM Debug @ 397 in fuzzybritchesv4.py] hiero')
    ...
    # end developers menu
        ...
        try:
            ...
            c.log('[CM @ 470 in fuzzybritchesv4]Traceback:: ' + str(failure))
            c.log('[CM @ 471 in fuzzybritchesv4]Error:: ' + str(e))
            pass
