...
#TC 2/01/19 started
        ...
        if control.addonInfo('id') == 'plugin.video.fuzzybritches_v4':
            try:
                ...
                if quality == 'AUTO':
                    ...
                    control.window.clearProperty("plugin.video.fuzzybritches_v4.container.items")
                    control.window.setProperty("plugin.video.fuzzybritches_v4.container.items", json.dumps(items))

                    control.window.clearProperty("plugin.video.fuzzybritches_v4.container.meta")
                    control.window.setProperty("plugin.video.fuzzybritches_v4.container.meta", meta)
                    control.window.clearProperty(self.itemProperty)
                    control.window.setProperty(self.itemProperty, json.dumps(items))
    ...
    def sourcesFilter(self):
        ...
        sortfuzzybritchesv4 = control.setting('torrent.sort.fuzzybritches.v4')
        if sortfuzzybritchesv4 == '':
            sortfuzzybritchesv4 = 'false'
